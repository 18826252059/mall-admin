package org.sandwich.litemall.core.system;

import org.sandwich.litemall.core.util.SystemInfoPrinter;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.sandwich.litemall.wx"));
