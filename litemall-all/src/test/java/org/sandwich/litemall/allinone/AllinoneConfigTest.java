package org.sandwich.litemall.allinone;
...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.org.sandwich.litemall.wx"));
        System.out.println(environment.getProperty("logging.level.org.sandwich.litemall.admin"));
        System.out.println(environment.getProperty("logging.level.org.sandwich.litemall"));
    }
